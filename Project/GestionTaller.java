...
public class GestionTaller{
  ...
  */
  private static final String menuPrincipal[]={
      ...
      "3.- Gestión de partes de reparación",
  ...
  */
   private static final String menuGestionDeVehiculos[]={
      "0.- Ir al menú principal",
      "1.- Dar de alta a un nuevo vehículo",
      "2.- Dar de baja a un vehículo",
      "3.- Mostrar los datos de un vehículo",
      "4.- Mostrar los datos de todos los vehículos",
      "5.- Modificar datos de un vehículo",
   ...
   */
    private static final String menuGestionDePartes[]={
      "0.- Ir al menú principal",
      "1.- Crear un nuevo parte de reparación",
      "2.- Finalizar la reparación de un vehículo",
      "3.- Dar un listado de todos los partes pendientes",
      "4.- Dar un listado de todos los partes de un cliente",
      "5.- Calcular el número de horas medias para los partes ya finalizados",
      "6.- Modificar el número de horas estimadas para la reparación de un vehículo"};
...
do{
  valorMenuPrincipal=elegirOpcionMenu("Menú Principal", menuPrincipal);
...
//CLIENTES
  ...
  case 1: valorMenuPrincipal=1;
   System.out.println("Ha seleccionado la opción Gestión de Clientes");
    
    do{ //Controla que no se introduzca un valor distinto de los marcados en los distintos casos.
     valorMenuGestionDeClientes=elegirOpcionMenu("Menú Gestión de Clientes", menuGestionDeClientes);
              ...
              switch(valorMenuGestionDeClientes){
               ...
               case 0: valorMenuGestionDeClientes=0; volverMenuPrincipal=true;
                 System.out.println("Ha seleccionado regresar al menú principal");
                 break;  
...
//VEHICULOS
  ...
  case 2: valorMenuPrincipal=2;
   System.out.println("Ha seleccionado la opción Gestión de Vehículos");
   
    do{ //Controla que no se introduzca un valor distinto de los marcados en los distintos casos.
     valorMenuGestionDeVehiculos=elegirOpcionMenu("Menú Gestión de Vehículos", menuGestionDeVehiculos);
            ...
            switch(valorMenuGestionDeVehiculos){
               ...
               case 1: valorMenuGestionDeVehiculos=1;
                 System.out.println("Ha seleccionado dar de alta a un nuevo vehículo");
                 gestionTaller.taller.altaVehiculo();
                 break;
               case 2: valorMenuGestionDeVehiculos=2;
                 System.out.println("Ha seleccinado dar de baja a un vehículo");
                 gestionTaller.taller.bajaVehiculo();
                 break;
               case 3: valorMenuGestionDeVehiculos=3;
                 System.out.println("Ha seleccionado mostrar los datos de un vehículo");
                 gestionTaller.taller.mostrarVehiculo();
                 break;
               case 4: valorMenuGestionDeVehiculos=4;
                 System.out.println("Ha seleccionado mostrar los datos de todos los vehículos");
                 gestionTaller.taller.inventarioVehiculos();
                 break;
               case 5: valorMenuGestionDeVehiculos=5;
                 System.out.println("Ha seleccionado modificar los datos de un vehículo");
                 gestionTaller.taller.modificarVehiculo();
                 break;
               case 6: valorMenuGestionDeVehiculos=6;
                 System.out.println("Ha seleccionado mostrar el historial de reparación de un vehículo");
...
//PARTES
  ...
  case 3: valorMenuPrincipal=3;
   System.out.println("Ha seleccionado la opción Gestión de Partes de Reparación");
    
    do{ //Controla que no se introduzca un valor distinto de los marcados en los distintos casos.     
     valorMenuGestionDePartes=elegirOpcionMenu("Menú Gestión de Partes de Reparación", menuGestionDePartes);
            ...
            switch(valorMenuGestionDePartes){
               ...
               case 1: valorMenuGestionDePartes=1;
                 System.out.println("Ha seleccionado crear un nuevo parte de reparación");
                 gestionTaller.taller.altaParte();
                 break;  
               case 2: valorMenuGestionDePartes=2;
                 System.out.println("Ha seleccionado finalizar la reparación de un vehículo");
                 gestionTaller.taller.finalizarReparacion();
                 break;
               case 3: valorMenuGestionDePartes=3;
                 System.out.println("Ha seleccionado dar un listado de todos los partes de reparación pendientes");
                 gestionTaller.taller.partesPendientes();
                 break;
               case 4: valorMenuGestionDePartes=4;
                 System.out.println("Ha seleccionado dar un listado de todos los partes de reparación de un cliente");
                 gestionTaller.taller.partesCliente();
                 break;
               case 5: valorMenuGestionDePartes=5;
                 System.out.println("Ha seleccionado calcular el número de horas medias reales para los partes ya finalizados");
                 gestionTaller.taller.horasMedias();
                 break;
               case 6: valorMenuGestionDePartes=6;
                 System.out.println("Ha seleccionado modificar el número de horas estimadas de reparación de un vehículo");
...
//ESTADO GENERAL
  case 4: valorMenuPrincipal=4;
   System.out.println("Ha seleccionado la opción Estado General Del Taller");
